  ...
  const handleSend = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isRouted) {
        ...
        const USDC_SAC_ADDRESS = process.env.NEXT_PUBLIC_USDC_CONTRACT_ID || "CBIELTK6YBZJU5UP2WWQEUCYKLPU6AUNZ2BQ4WWFEIE3USCIHMXQDAMA";
        const PHP_SAC_ADDRESS = process.env.NEXT_PUBLIC_PHP_CONTRACT_ID || "CCWXJRDLCIB2X6PFILH5GEE6ZQNBYX57N4LUVSDND3OVA3OYU52B3JN2";
